...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Password", "Passwort"),
        ("Ready", "Bereit (Verbunden mit Server)"),
        ...
        ("install_tip", "Eine Installation dieser Software ist normalerweise NICHT erforderlich und muss deswegen nur auf Verlangen des Service-Mitarbeiters durchgeführt werden."),
        ...
        ("Your installation is lower version.", "Ihre fest installierte Version ist veraltet und kann aktualisiert werden."),
        ...
        ("setup_server_tip", "FEHLER! Verbunden mit öffentlichem Server!"),
